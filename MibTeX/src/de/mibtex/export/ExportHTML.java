...
public class ExportHTML extends Export {
    ...
    void writeList(String title, List<?> list) {
        ...
        content.append("<center><h1>" + title + " <a href=\"index.htm\">(X)</a>");
    ...
    private void writeTableHeading(StringBuilder builder, String title) {
        builder.append("<th><a href=\"" + title + "s.htm\">" + title + "</a></th>");
    }
    
    private String getHTMLAuthor(BibtexEntry entry) {
        String s = "";
        for (String author : entry.authorList)
                s += "<a href=\"" + BibtexEntry.toURL(author) + ".htm\">" + author + "</a>, ";
    ...
    private String getHTMLTitle(BibtexEntry entry) {
        ...
        htmlTitle += " <a href=\"http://scholar.google.de/scholar?q=" + entry.title
    ...
    private String getHTMLTags(BibtexEntry entry) {
        ...
        for (String tag : entry.tagList)
                s += "<a href=\"" + BibtexEntry.toURL(tag) + ".htm\">" + tag + "</a>, ";
        return s.substring(0, s.length() - 2);
}
