...
public class ExportSamplingLatex extends ExportSampling {
	...
	public final static String KEYS = "AMS+:TOSEM18,AKT+:GPCE16,ALL+:VACE17,AMK+:GPCE16,ATL+:SoSyM16,AGV:ICST15,CR:IJAST14,DPL+:VaMoS15,FKPV:CEC16,EB+:ITNG11,EBG:CAiSE12,FLS+:CIM17,FLV:SBES17,FV:SBES15,FLRE:SBST16,GCD:ESE11,GKS+:PPL14,GRS+:CCPE17,GYS+:EMSE18,HNA+:TR17,HLHE:VaMoS13,HPL:SBSE14,HPP+:TSE14,HPP+:SPLC13,JHF:MODELS11,MHF:SPLC12,JHF+:MODELS12,KBK:AOSD11,KBBK:RV10,KSS:VariComp13,LKA+:ESECFSE13,LHF+:CEC14,MGSH:SPLC13,MKR+:ICSE16,OMR:SPLC10,OZLG:SPLC11,POS+:SQJ12,PSK+:ICST10,RBR+:SPLC15,SGS+:ASE15,SIMA:ASE13,SCD:FASE12,SSA:ESECFSE17,SGKA:ESECFSE15,SKK+:ICSE12,SRK+:IST13,SRK+:SQJ12,SRA:GPCE13,TDS+:ATC14,TLD:OSR12";
