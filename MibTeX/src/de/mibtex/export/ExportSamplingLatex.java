...
public class ExportSamplingLatex extends ExportSampling {
	...
	public final static String KEYS = "AMS+:TOSEM18,AKT+:GPCE16,AMK+:GPCE16,AGV:ICST15,CR:IJAST14,FKPV:CEC16,EB+:ITNG11,EBG:CAiSE12,FLS+:CIM17,FLV:SBES17,GCD:ESE11,GKS+:PPL14,GYS+:EMSE18,HLHE:VaMoS13,HPL:SBSE14,HPP+:TSE14,HPP+:SPLC13,JHF:MODELS11,MHF:SPLC12,JHF+:MODELS12,KBK:AOSD11,KBBK:RV10,KSS:VariComp13,LKA+:ESECFSE13,LHF+:CEC14,MGSH:SPLC13,MFV:JSERD16,MKR+:ICSE16,OMR:SPLC10,PSK+:ICST10,RBR+:SPLC15,SGS+:ASE15,SCD:FASE12,SKK+:ICSE12,SRK+:IST13,SRK+:SQJ12,TDS+:ATC14,TLD:OSR12,ALL+:VACE17,ATL+:SoSyM16,DPL+:VaMoS15,FLRE:SBST16,GRS+:CCPE17,HNA+:TR17,OZLG:SPLC11,POS+:SQJ12,SGKA:ESECFSE15,SRA:GPCE13";
